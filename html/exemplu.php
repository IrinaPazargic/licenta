    ...
    <table class="signup" border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee">
        ...
        <form id="form" method="post" action="inregistrare_admin.php" onSubmit="return validate(this)">
            <tr>
                <td>Nume</td>
                <td>
                    <input type="text" maxlength="32" name="nume" required=""/>
                </td>
            </tr>
            <tr>
                <td>Prenume</td>
                <td>
                    <input type="text" maxlength="32" name="prenume" required=""/>
                </td>
            </tr>
            <tr>
                <td>Adresa</td>
                <td>
                    <input type="text" maxlength="16" name="adresa" required=""/>
                </td>
            </tr>
            <tr>
                <td>Username</td>
                <td>
                    <input type="text" maxlength="16" name="username" required=""/>
                </td>
            </tr>
            <tr>
                <td>Password</td>
            ...
            <tr>
                <td>Telefon</td>
                <td>
                    <input type="text" maxlength="10" name="telefon" required=""/>
                </td>
            </tr>
            <tr>
                <td>Email</td>
                <td>
                    <input type="text" maxlength="64" name="email" required=""/>
                </td>
            </tr>
            <tr>
