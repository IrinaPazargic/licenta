        ...
        <div id="right">
            <div id="inserts">
                ...
                <div style="width: 500px; float:left;">
                    <fieldset>
                        <legend>
                            <a id="inregistrare" href="operatii_sali.php"
                                   style="background-color: red; text-decoration: none; color:black;"><span>Inregistrare sala</span></a>
                            ...
                            <form id="myForm" action="inregistrare_sala.php" method="POST">
                                <table id="table_sali">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="nr_sala" id="nr_sala"></td>
                                    </tr>
                                    <tr>
                                        <td><label for="randuri">Randuri: </label></td>
                                        <td><input type="text" name="randuri" id="randuri"></td>
                                    </tr>
                                    <tr>
                                        <td><label for="locuri" name="locuri">Locuri: </label></td>
                                        <td><input type="text" id="locuri"></td>
                                    </tr>
                                    <tr>
                                        <td><input type="submit" id="button" value="Salveaza"/></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </form>
