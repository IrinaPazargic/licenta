        ...
        $.ajax(
            {
                ...
                {
                    if(result == "Ok") alert("Stergere realizata cu succes");
    ...
    $(document).ready(function(){
       // $("#rezultat").hide();
        ...
        document.getElementById("table_program").innerHTML='<tbody><tr><td><label for="titlu">Titlu: </label></td><td><input type="text" name="titlu" id="titlu"></td></tr>' +
            ...
            '<tr><td></td><td></td><td><input type="submit" id="search" name="Search" onclick="ajaxCautaProgram()" value="Cauta"/></td></tr> </tbody>';
    ...
    <div style="width: 500px; float:left;">
        ...
        <fieldset>
            ...
            <table id="table_program">
                ...
                <tr> <td><input type="submit" id="salveaza" name="salveaza" value="Salveaza"/></td></tr>
                </tbody>
            </table>
