            ...
            <div id="menu_program">
                <ul>
                    <li id="current_program">
                        <a id="azi"
                           href="?data=<?= date("Y/m/d", $today) ?>&idCinema=<?= $idCinema ?>"><span> <?= date("d/m/Y", $today); ?> </span></a>
                    </li>
                    <li id="li_maine">
                        <a id="maine"
                           href="?data=<?= date("Y/m/d", $tomorrow) ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $tomorrow); ?> </span></a>
                    </li>
                    <li id="li_maine">
                        <a id="alta_zi"
                           href="?data=<?= date("Y/m/d", $day_after_tomorrow); ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $day_after_tomorrow); ?> </span></a>
                    </li>
                    <li id="li_alta_zi">
                        <a id="alta_zi_1"
                           href="?data=<?= date("Y/m/d", $other_day); ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $other_day); ?> </span></a>
                    </li>
                    <li id="li_alta_zi_2">
                        <a id="alta_zi_2"
                           href="?data=<?= date("Y/m/d", $other_day_1); ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $other_day_1); ?></span></a>
                    </li>
                    <li id="li_alta_zi_3">
                        <a id="alta_zi_3"
                           href="?data=<?= date("Y/m/d", $other_day_2); ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $other_day_2); ?></span></a>
                    </li>
                    <li id="li_alta_zi_4">
                        <a id="alta_zi_4"
                           href="?data=<?= date("Y/m/d", $other_day_3); ?>&idCinema=<?= $idCinema ?>"><span><?= date("d/m/Y", $other_day_3); ?></span></a>
                    </li>
                </ul>
            </div>
