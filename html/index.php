    ...
    <div id="mainContent">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <input class="submit" type="submit" value="CAUTA" name="do">
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div id="news" class="copyright">
            ...
            <div class="newsList">
                ...
                asteapta viitoarea victima �ntr-un apartament gol. Orele se scurg. Tensiunea creste...<br/><a href="" class="detailsLink" >Detalii film</a>
                </p>
            </div>
            <div class="newsList">
            <span class="icon_hold">
