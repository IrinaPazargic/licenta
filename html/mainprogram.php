                    ...
                    <tbody>
                        <tr>
                             <td style="text-align:left;width:200px;  padding: 5px;">
                                <a href="program.php?idCinema=<?= $row1['idCinema']?>" style="width: 150px; font-size:1.3em; text-decoration:none;text-transform: uppercase; border:1px solid black;"><strong>Galati</strong></a>
                             </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; width:100px; padding: 5px; ">
                                <a href="program.php?idCinema=<?= $row2['idCinema']?>" style="width: 150px; font-size:1.3em; text-decoration: none; text-transform: uppercase; border:1px solid black; "><strong>Bucuresti</strong></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
