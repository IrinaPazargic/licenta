...
<body id="feature">
    ...
    <ul id="mainNav">
        <li id="current"> <a href="noutati.php" id="homeLink"><span>Noutati</span></a></li>
        ...
        <a class="selectmap" style="background: none;margin-top:10px; float:right; margin-right:5px;" href="php.php">
    ...
    <div id="mainContent" >
        ...
        <h3 style="padding-top:10px; padding-left:10px; float:left;"><strong><a href="index.php" style="text-decoration:none;">Acasa >></a></strong><strong>Noutati </strong></h3>
        ...
        <div id="noutati">
            ...
            <p>Din data de 7 decembrie, te asteptam in cel mai nou multiplex din reteaua <strong>Cinema City, Cinema City
                    Ploiesti</strong> din cadrul Ploiesti Shopping City!
            <p><br/>
            <p>Ti-am pregatit:</p><br>
            <p> - 12 sali, toate digitale, din care 7 sali 3D;</p> <br/>
            <p> - 2087 locuri;</p><br/>
            <p> - cafenea de incinta unde poti savura cele mai bune produse din cafea, racoritoare si o selectie delicioasa
                de prajituri;</p><br/>
