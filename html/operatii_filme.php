...
<head>
    ...
    <script>
        function ajaxFunction() {
            ...
            ajaxRequest.open("GET", "cauta_film_functii.php" + queryString, true);
                    ...
                    <fieldset>
                        <legend>
                            <a id="inregistrare" href="operatii_filme.php"
                                style="background-color: red; text-decoration: none; color:black;">
                                <span>Inregistrare film</span>
                            </a>
                            <a id="cauta" style="background-color: gray;">
                                <span>Cauta Film</span>
                            </a>
                            <a id="sterge" style="background-color: gray;">
                                <span>Sterge Film</span>
                            </a>
                        </legend>
                            ...
                            <tbody>
                                <form enctype="multipart/form-data" action="filme_functions.php" method="POST">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="timp_desf" required=""></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="Regia" required=""></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="roluri_principale" required=""></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td><input type="submit" name="salveaza" value="Salveaza"/></td>
                                    </tr>
                                </form>
                            </tbody>
                        </table>
